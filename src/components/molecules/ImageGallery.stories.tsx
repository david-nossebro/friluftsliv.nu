...
const heroUrl = 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=1200&q=80'
const thumbUrls = [
...
export const WithCabinOverlay: Story = {
  args: {
    src: 'https://images.unsplash.com/photo-1449495169669-7b118f960251?w=1200&q=80',
