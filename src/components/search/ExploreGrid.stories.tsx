...
const mockItems: ExploreItem[] = [
  ...
  { kind: 'cabin', data: { id: '3', title: 'Abiskojaure STF', region: 'Abisko', amenities: ['Sovplatser', 'Kök'], pricePerNight: 350, imageUrl: 'https://images.unsplash.com/photo-1449158743715-0a90ebb6d2d8?w=560&q=70&auto=format' } },
  {
    kind: 'area',
    data: {
      id: '4',
  ...
  { kind: 'cabin', data: { id: '6', title: 'Sylarna Fjällstation', region: 'Jämtland', amenities: ['Restaurang', 'Bastu'], pricePerNight: 595 } },
]
